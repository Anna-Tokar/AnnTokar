...
int main() {
	...
	first_vector[2].push_back(3); // åñëè óáèðàåì - ñðàáîòàåò íóæíîå èñêëþ÷åíèå â êîíñòðóêòîðå
	// 1 2 3
	// 1 2 3
	// 1 2 3
...
// 3*3
	...
	// ïðîâåðêà óìíîæåíèÿ - ïî âåêòîðàì
	cout << "Mult 3*3: \n";
	...
	// ïðîâåðêà òðàíñïîíèðîâàíèÿ ìàòðèöû
	cout << endl;
	...
	//ïðîâåðêà çàïîëíåíèÿ åäèíèöàìè ìàòðèö
	cout << endl;
	Matrix a, b;
	cout << "\nOnes matrix a: " << endl;
	cout << a;
...
//3*4
	// ïðîâåðêà ñóììû - ïîïûòêà - òåñò âûáðîñà èñêëþ÷åíèÿ
	cout << "\nSum 3*3: \n";
	try {
	...
	// ïðîâåðêà ðàçíîñòè - ïîïûòêà - òåñò âûáðîñà èñêëþ÷åíèÿ
	cout << "\nDif 3*3: \n";
	try {
